...
namespace CashOut.Migrations
{
    ...
    [Migration("20260826025143_AddEffectiveCategories")]
    partial class AddEffectiveCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transaction", b =>
                {
                    b.HasOne("Category", "EffectiveCategory")
                        .WithMany()
                        .HasForeignKey("CategoryId");

                    b.HasOne("CategoryRule", "AssignedByRule")
                        .WithMany()
                        .HasForeignKey("CategoryRuleId");

                    b.Navigation("AssignedByRule");

                    b.Navigation("EffectiveCategory");
                });
